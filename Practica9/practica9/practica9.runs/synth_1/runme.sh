...
HD_PWD='C:/Users/yosaf/Desktop/Sexto/Arquitectura/Practica9/practica9/practica9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log automata.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source automata.tcl
