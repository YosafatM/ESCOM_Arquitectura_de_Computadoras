...
HD_PWD='C:/Users/yosaf/Desktop/Sexto/Arquitectura/Practica8/practica8/practica8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ruta.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ruta.tcl
