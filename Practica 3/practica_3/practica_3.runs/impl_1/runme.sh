...
HD_PWD='C:/Users/yosaf/Desktop/Sexto/Arquitectura/Practica 3/practica_3/practica_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_res_4bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sum_res_4bits.tcl -notrace
