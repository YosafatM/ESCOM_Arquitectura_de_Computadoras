...
HD_PWD='C:/Users/yosaf/Desktop/Sexto/Arquitectura/Practica 3/practica_3/practica_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_res_4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_res_4bits.tcl
